-- Sync DQ GHC content to Supabase
-- This script updates the dq-ghc guide in Supabase with the same content
-- that's hardcoded in the React component (GuidelinePage.tsx)
-- 
-- Run this in Supabase SQL Editor to keep the database in sync with the UI
...
-- Step 2: Update with the full GHC content (markdown format)
UPDATE public.guides
SET 
  title = 'DQ Golden Honeycomb of Competencies (GHC)',
  summary = 'The master framework, blueprint, and operating system that defines how Qatalysts think, work, create value, and grow. Seven interlinked competencies form DQ''s DNA.',
  body = '# Introduction
