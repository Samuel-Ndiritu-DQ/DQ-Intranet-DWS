...
-- NOSONAR - psql variable references (:'VAR') are required syntax and cannot be extracted as constants
-- Define constants
...
INSERT INTO glossary_terms (term, slug, short_definition, full_definition, category, used_in, related_terms, status, owner, updated_at) -- NOSONAR
VALUES
  (
    ...
    :'CATEGORY_FRAMEWORKS', -- NOSONAR
    ARRAY[:'ELEM_DWS_CORE', :'ELEM_GOVERNANCE'], -- NOSONAR
    ARRAY[:'SLUG_DWS_1', :'SLUG_DWS_2', :'SLUG_DWS_3', :'SLUG_DBP', :'SLUG_DCO'], -- NOSONAR
    :'STATUS_ACTIVE', -- NOSONAR
    :'OWNER_NAME', -- NOSONAR
    NOW()
  ),
  (
    ...
    :'CATEGORY_PLATFORMS', -- NOSONAR
    ARRAY[:'ELEM_DWS_CORE', :'SLUG_L24'], -- NOSONAR
    ARRAY[:'SLUG_DWS', :'SLUG_DWS_2', :'SLUG_DWS_3'], -- NOSONAR
    :'STATUS_ACTIVE', -- NOSONAR
    :'OWNER_NAME', -- NOSONAR
    NOW()
  ),
  (
    ...
    :'CATEGORY_FRAMEWORKS', -- NOSONAR
    ARRAY[:'ELEM_DWS_CORE', :'ELEM_GOVERNANCE'], -- NOSONAR
    ARRAY[:'SLUG_DWS', :'SLUG_DWS_1', :'SLUG_DWS_3'], -- NOSONAR
    :'STATUS_ACTIVE', -- NOSONAR
    :'OWNER_NAME', -- NOSONAR
    NOW()
  ),
  (
    ...
    :'CATEGORY_ROLES', -- NOSONAR
    ARRAY[:'ELEM_DWS_CORE', :'ELEM_GOVERNANCE'], -- NOSONAR
    ARRAY[:'SLUG_DWS', :'SLUG_DWS_1', :'SLUG_DWS_2'], -- NOSONAR
    :'STATUS_ACTIVE', -- NOSONAR
    :'OWNER_NAME', -- NOSONAR
    NOW()
  ),
  (
    ...
    :'CATEGORY_PLATFORMS', -- NOSONAR
    ARRAY[:'ELEM_DWS_CORE', :'ELEM_GOVERNANCE'], -- NOSONAR
    ARRAY[:'SLUG_DWS', :'SLUG_DCO'], -- NOSONAR
    :'STATUS_ACTIVE', -- NOSONAR
    :'OWNER_NAME', -- NOSONAR
    NOW()
  ),
  (
    ...
    :'CATEGORY_GOVERNANCE', -- NOSONAR
    ARRAY[:'ELEM_DWS_CORE', :'ELEM_GOVERNANCE', :'ELEM_LEARNING_CENTER'], -- NOSONAR
    ARRAY[:'SLUG_DWS', :'SLUG_GHC', :'SLUG_L24'], -- NOSONAR
    :'STATUS_ACTIVE', -- NOSONAR
    :'OWNER_NAME', -- NOSONAR
    NOW()
  ),
  (
    ...
    :'CATEGORY_WAYS', -- NOSONAR
    ARRAY[:'SLUG_L24', :'ELEM_DWS_CORE'], -- NOSONAR
    ARRAY[:'SLUG_DWS', :'SLUG_DWS_1', :'SLUG_DCO'], -- NOSONAR
    :'STATUS_ACTIVE', -- NOSONAR
    :'OWNER_NAME', -- NOSONAR
    NOW()
  ),
  (
    ...
    :'CATEGORY_FRAMEWORKS', -- NOSONAR
    ARRAY[:'ELEM_DWS_CORE', :'ELEM_GOVERNANCE'], -- NOSONAR
    ARRAY[:'SLUG_DWS', :'SLUG_DTMF'], -- NOSONAR
    :'STATUS_ACTIVE', -- NOSONAR
    :'OWNER_NAME', -- NOSONAR
    NOW()
  ),
  (
    ...
    :'CATEGORY_GOVERNANCE', -- NOSONAR
    ARRAY[:'ELEM_DWS_CORE', :'ELEM_GOVERNANCE'], -- NOSONAR
    ARRAY[:'SLUG_DWS', :'SLUG_DT2_0'], -- NOSONAR
    :'STATUS_ACTIVE', -- NOSONAR
    :'OWNER_NAME', -- NOSONAR
    NOW()
  ),
  (
    ...
    :'CATEGORY_FRAMEWORKS', -- NOSONAR
    ARRAY[:'ELEM_LEARNING_CENTER', :'ELEM_GOVERNANCE', :'ELEM_DWS_CORE'], -- NOSONAR
    ARRAY[:'SLUG_DWS', :'SLUG_DCO'], -- NOSONAR
    :'STATUS_ACTIVE', -- NOSONAR
    :'OWNER_NAME', -- NOSONAR
    NOW()
