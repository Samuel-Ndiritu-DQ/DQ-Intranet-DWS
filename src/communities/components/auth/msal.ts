...
console.log('🔐 Azure AD Authority (Communities):', computedAuthority);
console.log('🔐 Azure AD Client ID (Communities):', CLIENT_ID);
console.log('🔐 Azure AD Tenant ID (Communities):', TENANT_ID);
