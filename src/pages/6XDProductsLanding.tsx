...
const SIXXD_CARDS = [
  ...
  // Class 02 — Delivery Products (DT 2.0)
  {
    id: "dtmp",
    number: 2,
    category: "Class 02 — Delivery Products (DT 2.0)",
    title: "DTMP",
  ...
  // Class 04 — Transaction Platforms (TxM)
  {
    ...
    executionQuestion: "What: Transaction platform for consumer and enterprise ecosystems.",
    executionLens: "Why: Makes handoffs repeatable, trackable, and scalable across journeys.",
    route: "/marketplace/directory/products",
    icon: Layers as LucideIcon,
    gradient: "bg-gradient-to-br from-[#131e42] via-[#1d2f64] to-[#e1513b]",
    accent: "#f0f6ff",
