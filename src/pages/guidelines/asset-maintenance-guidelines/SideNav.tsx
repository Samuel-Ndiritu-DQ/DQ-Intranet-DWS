...
const sections = [
  ...
  { id: 'reporting-escalation', label: 'Reporting and Escalation Flow' },
  { id: 'maintenance-repair-disposal', label: 'Maintenance, Repair and Disposal Process' },
  ...
  { id: 'continuous-improvement', label: 'Continuous Improvement and Feedback Loop' },
]
