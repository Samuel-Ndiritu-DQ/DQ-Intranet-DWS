...
const sections = [
  ...
  { id: 'dress-code-details', label: 'Dress Code Details' },
  { id: 'preparation', label: 'Preparation Before Implementation' },
  { id: 'guidelines-during-workdays', label: 'Guidelines During Workdays' },
  { id: 'special-considerations', label: 'Special Considerations' },
  { id: 'prohibited-attire', label: 'Prohibited Attire' },
  { id: 'post-implementation', label: 'Post-Implementation Review' },
]
