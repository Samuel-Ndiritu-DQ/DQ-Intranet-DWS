...
function GuidelinePage() {
  ...
  const contentKey = 'dq-agile-flows'
  ...
  useEffect(() => {
    ...
    ;(async () => {
      try {
        ...
        if (fetchError) {
          console.error('❌ [DQ-AGILE-FLOWS] Fetch error:', fetchError)
          throw fetchError
        }
              ...
              <div className="lg:col-span-3">
                {activeTab === 'overview' && (
                  <div className="space-y-6">
                    ...
                    <div className="space-y-5">
                      <h3 className="text-2xl font-bold text-gray-900 mb-6">Agile Flows Highlights</h3>
                ...
                {activeTab === 'storybook' && (
                  <div className="space-y-6">
                    ...
                    <div className="pt-4">
                      <button
                        onClick={() => window.open('https://digital-qatalyst.shorthandstories.com/2e4a63e1-49da-48d1-a292-0e7f77c8636e/index.html', '_blank')}
                ...
                {activeTab === 'course' && (
                  <div className="space-y-6">
                    ...
                    <div className="pt-4">
                      <button
                        onClick={() => window.open('https://dq-intranet-pykepfa4x-digitalqatalysts-projects.vercel.app/lms/ghc-course/lesson/f237a74a-48fe-4388-ae47-aa8c3dbd3a0a', '_blank')}
                        className="inline-flex items-center gap-2 px-6 py-3 text-white font-medium rounded-lg transition-colors"
                        style={{ backgroundColor: '#f55436' }}
                        onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = '#d4442e' }}
                        onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = '#f55436' }}
