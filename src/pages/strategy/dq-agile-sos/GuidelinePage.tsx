  ...
  useEffect(() => {
    ...
    ;(async () => {
      try {
        ...
        if (fetchError) {
          console.error('❌ [DQ-AGILE-SOS] Fetch error:', fetchError)
          throw fetchError
        }
              ...
              <div className="lg:col-span-3">
                {activeTab === 'overview' && (
                  <div className="space-y-6">
                    ...
                    <div className="space-y-5">
                      <h3 className="text-2xl font-bold text-gray-900 mb-6">Agile SOS Highlights</h3>
                ...
                {activeTab === 'storybook' && (
                  <div className="space-y-6">
                    ...
                    <div className="pt-4">
                      <button
                        onClick={() => window.open('https://digital-qatalyst.shorthandstories.com/1201a61d-9475-48a1-a228-5342a75e094c/index.html', '_blank')}
