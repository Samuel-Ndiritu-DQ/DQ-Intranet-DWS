  ...
  useEffect(() => {
    ...
    ;(async () => {
      try {
        ...
        if (fetchError) {
          console.error('❌ [DQ-AGILE-TMS] Fetch error:', fetchError)
          throw fetchError
        }
              ...
              <div className="lg:col-span-3">
                {activeTab === 'overview' && (
                  <div className="space-y-6">
                    ...
                    <div className="space-y-5">
                      <h3 className="text-2xl font-bold text-gray-900 mb-6">Agile TMS Highlights</h3>
                ...
                {activeTab === 'storybook' && (
                  <div className="space-y-6">
                    ...
                    <div className="pt-4">
                      <button
                        onClick={() => window.open('https://digital-qatalyst.shorthandstories.com/cde3e47f-33f6-47c6-8633-3825276d17dd/index.html', '_blank')}
                ...
                {activeTab === 'course' && (
                  <div className="space-y-6">
                    ...
                    <div className="pt-4">
                      <button
                        onClick={() => window.open('https://dq-intranet-pykepfa4x-digitalqatalysts-projects.vercel.app/lms/ghc-course/lesson/e0c7d0c1-d726-45f9-80fe-16e5a4e5bc66', '_blank')}
                        className="inline-flex items-center gap-2 px-6 py-3 text-white font-medium rounded-lg transition-colors"
                        style={{ backgroundColor: '#f55436' }}
                        onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = '#d4442e' }}
                        onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = '#f55436' }}
