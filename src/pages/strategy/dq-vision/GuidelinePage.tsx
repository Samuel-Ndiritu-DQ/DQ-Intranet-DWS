              ...
              <div className="lg:col-span-3">
                {activeTab === 'overview' && (
                  <div className="space-y-6">
                    ...
                    <div className="space-y-5">
                      <h3 className="text-2xl font-bold text-gray-900 mb-6">Vision Highlights</h3>
                ...
                {activeTab === 'course' && (
                  <div className="space-y-6">
                    ...
                    <div className="pt-4">
                      <button
                        onClick={() => window.open('https://dq-intranet-pykepfa4x-digitalqatalysts-projects.vercel.app/lms/ghc-course/lesson/60912d69-547e-4e26-8f7b-59ac8aa845fc', '_blank')}
                        className="inline-flex items-center gap-2 px-6 py-3 text-white font-medium rounded-lg transition-colors"
                        style={{ backgroundColor: '#030E31' }}
                        onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = '#020A28' }}
                        onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = '#030E31' }}
